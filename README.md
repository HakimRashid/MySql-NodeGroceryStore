...
1. To get started with this assignment, the development directory with the [starter project code files is www](www). Follow the [setup instructions](setup/) to create your development environment.
...
5. A good way to get started with `/routes/listorder.js` is to copy some of the [sample code posted](www/sample/QuerySQLServer.js) and modify it for this particular query.
